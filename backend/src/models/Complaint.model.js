...
const complaintSchema = new mongoose.Schema(
  {
    ...
    damage_type: { type: String, trim: true },
    severity_level: { type: String, trim: true },
    severity_score: { type: String, trim: true },
...
complaintSchema.index({ citizen_id: 1, createdAt: -1 });
complaintSchema.index({ region: 1, status: 1 });
